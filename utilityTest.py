...
class MyTestCase(unittest.TestCase):
    ...
    def test_tick(self):
        ...
        util = Utility(obsranges=np.array([[0.0, 0.0], [3.0, 3.0]]))
    ...
    def test_drawrewards(self):
        util = Utility(obsranges=np.array([[0.0, 3.4], [0.0, 5.0], [2., 3.]]))
    ...
    def test_draw(self):
        util = Utility(obsranges=np.array([[0.0, 2.0], [0.0, 1.0]]))
        for x in range(0, 40):
