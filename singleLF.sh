...
screen -r "Gridsearch" -X stuff $'python3 ./experiments/lf_placecells.py --processes=1 --headless;rsync -rtuv ./experimentdata benediktvogler@192.168.2.3:~/Studium/Masterarbeit/SNNexperiments/;\n'
EOF